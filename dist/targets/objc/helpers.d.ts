 ...
 */
export declare const nsDeclaration: (nsClass: string, name: string, parameters: Record<string, any>, indent?: boolean | undefined) => string;
/**
 * Create a valid Objective-C string of a literal value according to its type.
 *
 * @param value Any JavaScript literal
 */
export declare const literalRepresentation: (value: any, indentation?: number | undefined) => string;
